window.onload = function() {
    ...
    for (var i = 0; i < tr.length; i++) {
        tr[i].onclick = function(e) {
            ...
            switch (cls) {
                case "add":
                	var cartID = document.getElementsByClassName("shoppingCarId");
                	countInput.value = value + 1
                	var f = document.forms[0];
                	f.action = "updateShoppingCar?id="+cartID+"&quantity="+countInput.value;
                	f.submit();
                	/*
                    countInput.value = value + 1;
                    getSubtotal(this);*/
                ...
                case "delete":
                    ...
                    if (con) {
                    	var cartID = document.getElementsByClassName("shoppingCarId");
                    	var f = document.forms[0];
                    	f.action = "deleteShoppingCar?id="+cartID;
                    	f.submit();
