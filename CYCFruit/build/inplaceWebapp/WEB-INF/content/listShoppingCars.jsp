          ...
          <s:form action="order">
                <table id="cartTable">
                    ...
                    <tbody>
                      ...
                      <s:iterator value="shoppingCars" status="sc">  
 							<s:if test="f.id == sc.fruitID">
                        <tr>
                            <td class="checkbox">
                                <input type="checkbox" name="id" class="check-one check" value="${sc.id}">
                            </td>
                            <td class="goods">
                            ...
                            <td class="count">
                                ...
                                <input type="text" class="count-input" value="${sc.quantity }" name="">
                                <span class="add">+</span>
                            </td>
                            <td class="subtotal">9.9</td>
                            <td class="operation">
                                <span class="delete">删除</span>
                                <input type="hidden" class="shoppingCarId" value="${sc.id}"/>
                            </td>
                        </tr>
                        </s:if>
                        </s:iterator>
                ...
                <div id="foot" class="foot">
                    ...
                    <div class="fr closing" ><s:submit value="结算" /></div>
