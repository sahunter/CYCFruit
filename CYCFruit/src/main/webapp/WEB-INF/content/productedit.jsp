    ...
    <div data-options="fit:true">
        ...
        <div class="editcontent" style="padding:10px;background:#fff;border:1px solid #ccc;height:200px;">
            <div id="maindata">
                ...
                <s:form action="fruitadd">
                <table class="table table-hover table-condensed">
                    <tr>
                        <th>商品名称</th>
                        <td colspan="3">
                            <s:textfield id="FULLNAME" name="fruit.fruitname" class="span5" style="width:322px;"/>
                        </td>
                    </tr>
                    <tr>
                        <th>商品图片</th>
                    ...
                    <tr>
                        <th>商品类别</th>
                        <td colspan="3">
                              <s:textfield id="FULLNAME" name="fruit.category" class="span5" style="width:322px;"/>
                        </td>
                    </tr>
