    ...
    <div id="cc" class="easyui-layout" style="width:100%;height:100%;">
        ...
        <div region="west" title="导航菜单栏" style="width:180px;">
            <ul id="tt1" class="easyui-tree" data-options="animate:true,dnd:true">
                ...
                <li><a href="inventory.html">库存统计</a></li>
                <li><a href="sales.html">销售统计</a></li>
            </ul>
        </div>
        <!-- 主显示区域选项卡界面 -->
        <div region="center">
            <div class="easyui-tabs" fit="true" id="tt">
                <div title="首页" data-options="closable:true">
                    <iframe width='100%' height='100%' id='iframe' name='iframe' frameborder='0' scrolling='auto' src='inventory-body.html'></iframe>
                </div>
            </div>
        </div>
        <div id="dd"></div>
