...
<body>
	...
	<table id="cartTable">
                    <tbody>
                    <s:iterator value="fruits" var="b">
                     <s:form action="fruitupdate">
                        <tr>
                         <td class="unit-price"><s:textfield  name="id" value="${b.id}"/></td>
                            <td class="goods">
                                <img src="${b.picture}">
                                <span><s:textfield name="fruitname" value="${b.fruitname}"/></span>
                            </td>
                            <td class="unit-price"><s:textfield name="price" value="${b.price}"/></td>
                            <td class="count">
                        <s:textfield name="category" value="${b.category}"/>
                            ...
                            <td class="operation">
                              <a href="${pageContext.request.contextPath}/fruitdelete?id=${b.id}">删除</a>
                            </td>
                        </tr>
                        </s:form>
                        </s:iterator>
